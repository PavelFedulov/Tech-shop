...
const appleMBPPicsArray = [
  ...
  './img/AppleImg/MacBook_Pro_1.jpg',
  './img/AppleImg/MacBook_Pro_3.jpg',
  './img/AppleImg/MacBook_Pro_4.jpg'
];
...
const appleCardList = [
  ...
  { pic: appleMBPPicsArray[3], model: "MacBook Pro", year: 2015 },
  { pic: appleMBPPicsArray[4], model: "MacBook Pro", year: 2015 },
  { pic: appleMBPPicsArray[5], model: "MacBook Pro", year: 2015 },
];
